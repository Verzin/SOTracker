...
def main():
    ...
    parser.add_argument('tracker_name', type=str, default='segm',help='Name of tracking method.')
    ...
    # entry_Input_path = '/data2/Verzin/TestVideo/1.mp4'
    # run_video('segm','default_params',entry_Input_path)
