...
class Tracker:
    ...
    def run(self, seq, visualization=True, debug=None):
    ...
    def run_video(self, Inputvideofilepath,Outputvideofilepath,ObjectLength,TypeVideo,optional_box=None, debug=None):
        ...
        tracker = self.tracker_class(self.parameters)
        tracker.track_videofile(Inputvideofilepath ,Outputvideofilepath,ObjectLength,TypeVideo,optional_box)
